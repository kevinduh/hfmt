...
#qsub -S /bin/bash -V -cwd -j y -q gpu.q@@v100 -l gpu=1,h_rt=24:00:00,num_proc=8,mem_free=25G scripts/exp/spa/train_1k.sh
...
trainset=$rootdir/egs/data/CCMatrix-train/es-en.train.bitext
